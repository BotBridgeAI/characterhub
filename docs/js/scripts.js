...
function fetchBots() {
    ...
    fetch('https://characters.botbridge.net/api/bots/pending', {
        method: 'GET',
        headers: {
            'Authorization': token
        }
...
function approveBot(botId) {
    ...
    fetch(`https://characters.botbridge.net/api/bots/${botId}/approve`, {
        method: 'POST',
        headers: {
            'Authorization': token
        }
...
function denyBot(botId) {
    ...
    fetch(`https://characters.botbridge.net/api/bots/${botId}/deny`, {
        method: 'POST',
        headers: {
            'Authorization': token
        }
