...
async function fetchCharacters() {
    try {
        const response = await fetch('https://characters.botbridge.net/api/characters/all'); // Assuming this endpoint fetches all characters
        if (response.ok) {
...
async function updateCharacterStatus(id, status) {
    try {
        await fetch(`https://characters.botbridge.net/api/characters/user/${id}`, {
            method: 'PATCH',
